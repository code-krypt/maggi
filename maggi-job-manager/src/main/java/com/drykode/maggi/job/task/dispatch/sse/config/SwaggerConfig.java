package com.drykode.maggi.job.task.dispatch.sse.config;
...
public class SwaggerConfig {
  ...
  @Value(
      "#{'${maggi.configurations.swagger.definitions.api.produces:application/json}'.split(',')}")
  private Set<String> apiOutputFormats;

  @Value(
      "#{'${maggi.configurations.swagger.definitions.api.consumes:application/json}'.split(',')}")
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.drykode.maggi.job"))
